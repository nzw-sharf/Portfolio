...
<html lang="en">
<head>
<title>Create Clients <?php echo $fullTitle; ?></title>
					...
					<div class="col-12 col-md-6 order-md-2 order-first">
						<nav aria-label="breadcrumb" class='breadcrumb-header'>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Insert Client</li>
							</ol>
						</nav>
					</div>
				</div>
										...
										<div class="row">
											...
											<div class="col-md-12 col-12">
												<div class="form-group">
													...
													<input type="text" class="form-control form-control-lg" name="client_name" placeholder="Client Name *" required />
												</div>
											</div>
											<!-- Line -->
											<!-- Line -->
											...
											<!-- Line -->
											<?php @$msgV = $_GET["msg"]; if(isset($_GET["msg"])){echo "<span style='color:red; font-weight:bold;'>".$msgV."</span>";}else{} ?>
											<hr />
											<div class="col-12 d-flex justify-content-end">
												<button type="submit" class="btn btn-lg btn-primary mr-1 mb-1 upload_client" name="upload_client">Upload Client</button>
											</div>
										</div>
									</form>
									<?php
										...
										if(isset($_POST["upload_client"])){
											...
											move_uploaded_file($imgFile_tmp, "../images/clients/$Nu_imgFile_name");
							
											$insert_query = "insert into clients (admin_id, client_name, client_image, upload_date) values ('$adm_id_a','$client_name','$Nu_imgFile_name',NOW())";
										
											$run_query	= mysqli_query($con, $insert_query);
										
											if($run_query){
												echo "<script>window.open('insert_clients.php?msg=Client Details has been Published Successfully','_self')</script>";
											}else{
												echo "<script>window.open('insert_clients.php?msg=There Was A Problem, Please Try Again!','_self')</script>";
											}
										}
									?>
								</div>
