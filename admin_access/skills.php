...
<html lang="en">
<head>
<title>Skills - <?php echo $fullTitle; ?></title>
			...
			<section id="basic-modals">
				<div class="row">
					<?php
						...
						$proDBQue = "select * from skills ORDER BY 1 DESC";
					...
					<div class="col-md-4 col-12 divBox">
						<div class="card">
							<div class="card-content">
								<img src="../images/logo-light.png" class="card-img-top img-fluid" alt="<?php echo $fch_skillName; ?>" title="<?php echo $fch_skillName; ?>" />
								<div class="card-body">
									<p class="card-text"><b><?php echo $fch_skillName; ?></b></p>
								</div>
							</div>
							<div class="card-footer d-flex justify-content-between">
								<a href="edit_skill.php?edit_skill=<?php echo $fch_skillID; ?>" class="btn btn-outline-primary">Edit</a>
								<button class="btn btn-outline-primary delBtn" delID="<?php echo $fch_skillID; ?>">Delete</button>
							</div>
						</div>
					</div>
					<?php }} ?>
